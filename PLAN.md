...
Phase 11 — Review Image Evidence
Phase 12 — Review Datasheet Evidence
Phase 13 — Cross-Source Consistency Review
Phase 14 — Candidate Finding Development
Phase 15 — Write Findings JSON
Phase 16 — Validate and Repair Findings
Phase 17 — Generate Report
...
## Phase 8 — Review Board/Layout Evidence
- **Purpose**: Perform board/layout evidence review.
- **Files/tools to inspect/use**: Generated board JSON, layout PNG context if relevant.
- **Expected evidence/output**: Coverage of routing geometry, widths/lengths, pads, vias/holes, copper/non-copper separation, physical grouping, and limitations.
- **Validation/checkpoint before moving to next phase**: Board JSON treated explicitly as exported geometry evidence, not DRC.
